...
class CodeSummaryModel(nn.Module):
    ...
    def __init__(self, encoder1,encoder2, decoder):
        ...
        self.mn_encoder = encoder1
        self.bd_encoder = encoder2
        self.decoder = decoder
        self.h_trans=nn.Linear(800,400)
        self.c_trans=nn.Linear(800,400)
    ...
    def forward(self, src, tgt, lengths, bptt=False, with_align=False):
        ...
        mn_enc_state,mn_memory_bank,mn_lengths=self.mn_encoder(src[0],lengths[0])
        mn_enc_h,mn_enc_c=mn_enc_state
        bd_enc_state,bd_memory_bank,bd_lengths=self.bd_encoder(src[1],lengths[1])
